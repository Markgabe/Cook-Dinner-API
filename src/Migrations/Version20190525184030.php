 ...
 */
final class Version20190525184030 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE avaliacao (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, receita_id INTEGER NOT NULL, nota INTEGER DEFAULT NULL, favorito BOOLEAN NOT NULL, CONSTRAINT FK_691B4722B91BA9FB FOREIGN KEY (receita_id) REFERENCES receita (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__receita AS SELECT id, user_id, nome, descricao, image FROM receita');
        ...
        $this->addSql('INSERT INTO receita (id, user_id, nome, descricao, image) SELECT id, user_id, nome, descricao, image FROM __temp__receita');
